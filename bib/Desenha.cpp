...
void Desenha::drawCube(GLfloat xmin, GLfloat ymin, GLfloat zmin, GLfloat width, GLfloat height, GLfloat depth) {
    glPushMatrix();

    glTranslatef(xmin, ymin, zmin);
    glScaled(width/1.0, height/1.0, depth/1.0);
    glutSolidCube(1.0);
    // desempilha a matriz do sistema local
    glPopMatrix();

}

void Desenha::drawCylinder(GLfloat xmin, GLfloat ymin, GLfloat zmin, GLfloat width, GLfloat height, GLfloat depth) {
    glPushMatrix(); // 1
